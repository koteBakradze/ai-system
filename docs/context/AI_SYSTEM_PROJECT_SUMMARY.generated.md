...
- Generated: 2026-05-12T21:14:39+00:00
...
|   |   `-- safety-review.md
|   |-- prompts
|   |   |-- create-income-research-workflow.md
|   |   |-- implement-real-research-gateway.md
|   |   |-- review-changes.md
|   |   |-- start-session.md
...
|-- docs
|   |-- context
|   |   |-- AI_SYSTEM_CURRENT_WORKFLOW.md
|   |   |-- AI_SYSTEM_FILE_STRUCTURE.md
|   |   |-- AI_SYSTEM_LONG_TERM_GOAL_AND_PROGRESS.md
...
|   |   |-- 20260512-145831-test-topic.md
|   |   |-- 20260512-145901-best-local-llm-coding-workflow-2026.md
|   |   |-- 20260512-150048-best-local-llm-coding-workflow-2026.md
|   |   |-- 20260512-211414-test-topic.md
|   |   `-- __init__.py
|   |-- tasks
|   |   `-- __init__.py
|   `-- __init__.py
...
- CLI tasks: `api`, `coding`, `discover`, `exit`, `fast`, `general`, `project_context_export`, `research`, `research-context`, `review`, `usage`.
